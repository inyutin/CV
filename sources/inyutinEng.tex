...
{inyutin.da@gmail.com | \href{https://github.com/inyutin}{\faGithub \, inyutin}}
\end{minipage}
...
{Assisted with the “Theory and Practice of Concurrent Computing” course. \\
 I read seminars and reviewed students’ homework.}
...
\ProgrammingEntry
{\textbf Python}
{The language I know best. I have 2+ years of experience. \\
Familiar with aiolibs.}
\bigskip
\ProgrammingEntry
{C++}
{Actively use it for educational projects. Familiar with standard containers and synchronization primitives.}
\bigskip
...
\ProgrammingEntry
{Aiohttp-retry}
{Simple retry client over aiohttp. This package available on PyPi.}
\bigskip
\ProgrammingEntry
{CASPaxos}
